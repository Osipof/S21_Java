...
public class Main {
    ...
    private static void createTable(ApplicationContext context) {
        ...
        try (Connection con = dataSource.getConnection();
            ...
            st.executeUpdate("drop schema if exists spring cascade;");
            st.executeUpdate("create schema if not exists spring;");
            st.executeUpdate("create table if not exists spring.user "
