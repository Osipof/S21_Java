...
public class User {
    ...
    public boolean equals(Object o) {
        ...
        User user = (User) o;
        return id == user.id && Objects.equals(login, user.login) && Objects.equals(password, user.password) && Objects.equals(createdRooms, user.createdRooms) && Objects.equals(usedRooms, user.usedRooms);
    }
